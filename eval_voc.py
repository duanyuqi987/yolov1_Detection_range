...
if __name__ == '__main__':
    ...
    model.load_state_dict(predict.torch.load('./yolo_test.pth'))
    model.eval()
    model.cuda()
    count = 0
    for image_path in tqdm(image_list):
        result = predict.predict_gpu(model,image_path,root_path='./data/') #result[[left_up,right_bottom,class_name,image_path],]
